...
const CONFIG = {
  ...
  // Фильтры
  minVolatility: 10,          // Минимум 10% изменение за 24ч
  minVolume: 100000,          // $100K минимальный объем
  minTrades: 100,             // Минимум 100 сделок за 24ч
  topCoinsPerExchange: 50,    // Топ-50 с каждой биржи
